...
{
    public class Table11Controller : Controller
    {
        ...
        public async Task<ActionResult> SignIn([Bind(Include = "UserID,Email,Password,ConfirmPassword,IsEmailVerified,ActivationCode")] Table1 table1)
        {
